                ...
                <div class="ct_right_ct">
                    ...
                    <figure class="logo_login">
                        <a href="#"><img style="width: 210px !important"
                                src="{{ asset('backend/assets/img/logo-sgo-media-file-chot-1.png') }}"
                                alt="logo-sgo-media"></a>
                    </figure>

                    <div class="login_form">
                        <form method="post" accept-charset="utf-8" id="form-login" action="{{ route('admin.submitLogin') }}">
                            @csrf

                            <div class="form_group" style="display: block;">
                                <div class="list_group">
                                    <input type="text" name="email" autocomplete="off"
                                        placeholder="Địa chỉ Email" id="email" value="admin@gmail.com">
